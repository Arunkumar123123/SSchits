...
const PlanList = () => {
  ...
  const fetch = async () => {
    try {
      ...
      if (response.data.success) {
        setFormData(response.data.data.plans)
  ...
  return (
    <div>
      ...
      <Transition.Root show={planCreateOpen} as={Fragment}>
        <Dialog
          as="div"
          className="relative z-10"
          onClose={setPlanCreateOpen}
        >
          <Transition.Child
            as={Fragment}
       ...
       {/*Modal Edit */}
       <Transition.Root show={planEditOpen} as={Fragment}>
        <Dialog
          as="div"
          className="relative z-10"
          onClose={setPlanEditOpen}
        >
          <Transition.Child
            as={Fragment}
            enter="ease-out duration-300"
      ...
      <Transition.Root show={PlanDelete} as={Fragment}>
            <Dialog
              as="div"
              className="fixed z-10 inset-0 overflow-y-auto"
              onClose={() => setPlanDelete(false)}
            >
                    ...
                    <div className="hidden sm:block absolute top-0 right-0 pt-4 pr-4">
                      <button
                        ...
                        onClick={() => {
                          setPlanDelete(false);
                          setDeleteMsg(
                            "Are you sure you want to delete the Delete Plan ?"
                          );
                        }}
                      >
